...
This blog post series is intended to give an overview of how datastores capable of supporting high volumes of data from IoT devices and Big Data services can be deployed on Kubernetes. To start with, the [StatefulSet](https://kubernetes.io/docs/concepts/workloads/controllers/statefulset/) primitive will be used to set up and deploy a [mongoDB Replica Set](https://docs.mongodb.com/manual/replication/) (cluster). [Part 2]({% post_url 2020-11-08-iot-bigdata-mongodb-deployment-kubernetes-part2 %}) demonstrates how other Kubernetes primitives such as [Secret](https://kubernetes.io/docs/concepts/configuration/secret/) can be applied to secure our initial, dummy deployment. [Part 3]({% post_url 2020-12-27-iot-bigdata-mongodb-deployment-kubernetes-part3 %}) of this series explains how to [shard](https://docs.mongodb.com/manual/sharding/) and further secure our mongoDB cluster. 
